...
class Product(models.Model):
    ...
    pic2 = models.ImageField(upload_to="uploads/products",default=None,blank=True,null=True)
    pic3 = models.ImageField(upload_to="uploads/products",default=None,blank=True,null=True)
    pic4 = models.ImageField(upload_to="uploads/products",default=None,blank=True,null=True)
...
orderStatusOptions = ((0,"Order Placed"),
                      ...
                      (4,"Shippied"),
                      (5,"Order in Transit"),
                      (6,"Product Reached at Final Delivery Station"),
                      (7,"Out for Delivery"),
                      (8,"Delivered"))
